...
export default async function ResourcesPage({
  ...
  const { data: resources, error } = await query.order('created_at', { ascending: false }).limit(20);
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <main className="flex-1 w-full">
            ...
            <div className="relative mb-8 group">
              <div className="absolute inset-y-0 start-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-teal-600 transition-colors ps-4">
                <Search size={22} />
              </div>
              <input
                type="text"
